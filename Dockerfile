...
ENV JAVA_SCC_OPTS "-Xms1G -Xmx2648m -server -XX:+UseG1GC -Xshareclasses:name=tomcat_scc,cacheDir=/tmp,enableBCI -Xscmx20M"
ENV JAVA_OLD_OPTS ${JAVA_OPTS}
ENV JAVA_OPTS "${JAVA_SCC_OPTS} ${JAVA_OPTS}"
ENV CATALINA_OPTS="-Xms1G -Xmx2648m -server -XX:+UseG1GC"
